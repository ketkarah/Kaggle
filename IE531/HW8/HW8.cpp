...
int main(int argc, char* argv[]) {
	...
	for (int z = 0; z < 11; z++) {
		...
		means.push_back(mean/X_xcount.size());
	...
	cout << "Mean of F2 estimates "<< meansum / means.size() << endl;
	//cout << "Median of F2 estimates " << find_median(means) << endl;
	return 0;
}
